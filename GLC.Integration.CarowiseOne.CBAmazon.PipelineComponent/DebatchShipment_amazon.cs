...
namespace GLC.Intergration.CargowiseOne.CBAmazon.PipelineCompoents
{
    [Serializable]
    ...
    public class DebatchShipment : IBaseComponent, IComponent, IComponentUI
    {
        ...
        public string Name
        {
            get { return "DebatchShipment_amazon"; }
        }
        ...
        public Microsoft.BizTalk.Message.Interop.IBaseMessage Execute(Microsoft.BizTalk.Component.Interop.IPipelineContext pc, Microsoft.BizTalk.Message.Interop.IBaseMessage inmsg)
        {
            ...
            foreach (XmlNode node in xmlnode)
            {
                ...
                string filepath = @"C:\CBAmazon_Debatch\CBAmazonFile_" + cnt + "_" + DateTime.Now.ToString("ddMMyyyyHHmmss") + ".xml";
